document.addEventListener('DOMContentLoaded', () => {
    const canvas = document.getElementById('teapoyCanvas');
    ...
    // Stride loading (decimation). Stride 1 loads all 45 frames sequentially.
    const stride = 1;
    ...
    const textDesc = document.getElementById('teapoyDesc');
